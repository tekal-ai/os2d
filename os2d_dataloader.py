...
def os2d_collate_fn(data):
    ...
    for ref in logos:
        for logo in ref:
            logos_ls.append(logo)
    return reference_images_th, logos_ls, loc_targets_th, class_targets_th, list(class_ids), list(logo_sizes), list(box_inverse_transform), list(boxes), list(img_size)
