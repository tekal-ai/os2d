...
class SyntheticAugmentationsDataset(Dataset):
    ...
    def sample_xy_coordinates(self, img_size, object_size, max_occlusion=0.15):
        x = int(random.uniform(-object_size[0] * max_occlusion, img_size[0] - (1 - max_occlusion) * object_size[0]))
    ...
    def _sample_object_placements(self, img, object_to_paste, angle, max_occlusion=0.15, num_samples=6):
        sampled_placements = []
        ...
        for i in range(num_samples):
            cur_x, cur_y = self.sample_xy_coordinates((img_w, img_h), (object_w, object_h), max_occlusion)
    ...
    def __getitem__(self, idx):
        ...
        class_img = self._add_colored_background(class_img, bg_color=(255, 255, 255, 255))
